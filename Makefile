...
module=github.com/ly95/go-wallet-sdk

pkgBase = ${module}/libmobile/src/go/mobile
...
buildAllSDKAndroid:
	gomobile bind -ldflags "-s -w" -target=android/arm,android/arm64 -androidapi 21 -o=${outdir}/wallet.aar ${pkgAll}
